...
<div class='grid'>
  <div><Image src={fume5} alt='Description'/><em><strong>Photo:</strong> The cabinet itself is connected with dovetails, glued, and sealed with silicon.</em></div>
  <div><Image src={fume6} alt='Description'/><em><strong>Photo:</strong> 3D printed knobs and covers for plexiglass installment.</em></div>
</div>
