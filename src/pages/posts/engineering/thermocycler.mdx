...
<Image src={thermo1} alt='thermoFinal' style="width: 47.4%;"/>
<Image src={thermo2} alt='thermoFinal' style="width: 50%;"/>
</div>
...
<Image src={d1} alt='thermoFinal' style="width: 40%;"/>
<Image src={d2} alt='thermoFinal' style="width: 50%;"/>
</div>
