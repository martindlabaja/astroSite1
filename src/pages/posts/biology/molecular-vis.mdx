...
<div class="imgWrap" data-lightbox="true">![Rubisco Protein Vis](bioVis01.png)</div>
...
genetic mutations by inserting a random tri-nucleotide repeat. Each mutagenesis cycle was then
processed by the Alpha Fold model.*
...
anti-lysozyme antibody and the antigen, hen egg white lysozyme.*
...
***Video 5:** My first successful molecular simulation of a protein folding using the Gasteiger solver (which also considers hydrogen bonding).
